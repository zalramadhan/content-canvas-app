...
- **👛 Dompet** — buat beberapa dompet (Tunai, Bank, E-Wallet) dengan ikon & warna; saldo dihitung otomatis dari transaksi; bisa **diedit** (klik ikon pensil) dan **dihapus** dengan pilihan penanganan transaksi terkait (pindahkan ke dompet lain / hapus transaksinya / biarkan tanpa dompet)
...
### 🌗 Lainnya
- **Menu hamburger** (☰) berisi: navigasi — **Calendar, Kanban, Dashboard, dan Ekspor** dikelompokkan dalam sub-menu **Content Creator** (bisa di-collapse biar sidebar tidak penuh), plus **Habits**, **Finance**, dan **Notes & Todo** — lalu search, **dark/light mode**, dan logout; tersedia di semua ukuran layar, navigasi kini hanya lewat hamburger (header tetap bersih)
